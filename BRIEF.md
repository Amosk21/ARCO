...
ARCO applies OWL-RL reasoning over a BFO-grounded, CCO-informed ontology to produce a **deterministic, entailment-based classification**. The output is not generated by an LLM or heuristic. Every conclusion follows from formal axioms over a machine-readable system description.
...
- **Standards alignment:** BFO 2020 import, RO/IAO IRIs, and local CCO-informed governance vocabulary stubs — no proprietary vocabulary
