...
|---|---|---|---|---|
| 1 | `README.md:137` | "the classification follows what a system is rather than how it happens to be described" contradicts `LIMITATIONS.md:29`, which says ARCO classifies the description and not the deployed system. `LIMITATIONS.md:3` gives itself precedence. | Delete the trailing clause. The three sentences after it already carry the payoff. | 5 min |
