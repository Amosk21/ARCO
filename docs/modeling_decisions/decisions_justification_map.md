...
**Why it matters**: Treating the grouping as a primitive subsumption would be Realism conviction failure: there is no real shared property to subsume by. The fiat partition model (cut + bearer + consequence) is the BFO-defensible move when membership is institutional, not natural.
